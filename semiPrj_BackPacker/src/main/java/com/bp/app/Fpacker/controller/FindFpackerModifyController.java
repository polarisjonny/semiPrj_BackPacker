...
@WebServlet ("/findFpacker/modify")
public class FindFpackerModifyController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		
		
		
		req.getRequestDispatcher("/WEB-INF/views/FpackerBoard/findFpackerModify.jsp").forward(req, resp);
	}
