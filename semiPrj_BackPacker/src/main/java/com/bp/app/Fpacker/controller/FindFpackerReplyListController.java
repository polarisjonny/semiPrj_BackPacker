...
@WebServlet ("/findFpacker/reply/list")
public class FindFpackerReplyListController extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			//데꺼
			String findFpackerNo = req.getParameter("findFpackerNo");
			
			//서비스
			GuideBoardService gbs = new GuideBoardService();
			List<GuideReplyVo>list =gbs.selectReplyList(findFpackerNo);
