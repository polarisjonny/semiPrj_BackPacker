...
@WebServlet ("/findFpacker/report")
public class FindFpackerReportController extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/WEB-INF/views/FpackerBoard/findFpackerReport.jsp").forward(req, resp);
	}
