...
@WebServlet("/notice/inquiryBoardDetail")
public class InquiryBoardDetailController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			InquiryVo vo = is.BoardDetail(qnaNo);
			
			if(vo !=null) {
				req.setAttribute("vo", vo);
				req.getRequestDispatcher("/WEB-INF/views/notice/inquiryBoardDetail.jsp").forward(req, resp);
			}else {
