...
@WebServlet ("/accompany/report")
public class AccompanyReportController extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/WEB-INF/views/accompanyBoard/accompanyBoardReport.jsp").forward(req, resp);
	}
