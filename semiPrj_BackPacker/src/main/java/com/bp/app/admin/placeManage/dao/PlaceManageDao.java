...
public class PlaceManageDao {
	...
	public List<PlaceVo> getPlaceList(Connection conn, PageVo pv) throws Exception {
		String sql = "SELECT *FROM (  SELECT ROWNUM RNUM, T.* FROM (SELECT P.PLACE_NO, P.PLACE_CATEGORY_NO, P.COUNTRY_NO, P.LOCATION_NO, P.PLACE_NAME AS NAME, P.PLACE_INTRODUCE, P.PLACE_IMAGE, P.PLACE_LAT, P.PLACE_LNG, P.PLACE_TIME, P.PLACE_EXPENSE, PC.PLACE_NAME AS PLACECATEGORY , LC.LOCATION_NAME AS LOCATIONCATEGORY, CC.COUNTRY_NAME AS COUNTRYCATEGORY FROM PLACE P JOIN PLACE_CATEGORY PC ON P.PLACE_CATEGORY_NO = PC.PLACE_CATEGORY_NO JOIN LOCATION_CATEGORY LC ON P.LOCATION_NO = LC.LOCATION_NO JOIN COUNTRY_CATEGORY CC ON P.COUNTRY_NO = CC.COUNTRY_NO WHERE PLACE_NO IS NOT NULL ORDER BY PLACE_NO DESC ) T ) WHERE RNUM BETWEEN ? AND ?";
	...
	public List<PlaceVo> getPlaceList(Connection conn, PageVo pv, String searchType, String searchValue) throws Exception {
		...
		if("name".equals(searchType)) {
			//sql(제목으로검색)
			sql = "SELECT *FROM (  SELECT ROWNUM RNUM, T.* FROM (SELECT P.PLACE_NO, P.PLACE_CATEGORY_NO, P.COUNTRY_NO, P.LOCATION_NO, P.PLACE_NAME AS NAME, P.PLACE_INTRODUCE, P.PLACE_IMAGE, P.PLACE_LAT, P.PLACE_LNG, P.PLACE_TIME, P.PLACE_EXPENSE, PC.PLACE_NAME AS PLACECATEGORY , LC.LOCATION_NAME AS LOCATIONCATEGORY, CC.COUNTRY_NAME AS COUNTRYCATEGORY FROM PLACE P JOIN PLACE_CATEGORY PC ON P.PLACE_CATEGORY_NO = PC.PLACE_CATEGORY_NO JOIN LOCATION_CATEGORY LC ON P.LOCATION_NO = LC.LOCATION_NO JOIN COUNTRY_CATEGORY CC ON P.COUNTRY_NO = CC.COUNTRY_NO WHERE PLACE_NO IS NOT NULL AND P.PLACE_NAME LIKE ('%'||?||'%') ORDER BY PLACE_NO DESC ) T )WHERE  RNUM BETWEEN ? AND ?";
			
		}else if("placeCategory".equals(searchType)) {
			//sql(작성자로검색)
			sql = "SELECT *FROM (  SELECT ROWNUM RNUM, T.* FROM (SELECT P.PLACE_NO, P.PLACE_CATEGORY_NO, P.COUNTRY_NO, P.LOCATION_NO, P.PLACE_NAME AS NAME, P.PLACE_INTRODUCE, P.PLACE_IMAGE, P.PLACE_LAT, P.PLACE_LNG, P.PLACE_TIME, P.PLACE_EXPENSE, PC.PLACE_NAME AS PLACECATEGORY , LC.LOCATION_NAME AS LOCATIONCATEGORY, CC.COUNTRY_NAME AS COUNTRYCATEGORY FROM PLACE P JOIN PLACE_CATEGORY PC ON P.PLACE_CATEGORY_NO = PC.PLACE_CATEGORY_NO JOIN LOCATION_CATEGORY LC ON P.LOCATION_NO = LC.LOCATION_NO JOIN COUNTRY_CATEGORY CC ON P.COUNTRY_NO = CC.COUNTRY_NO WHERE PLACE_NO IS NOT NULL AND PC.PLACE_NAME LIKE ('%'||?||'%') ORDER BY PLACE_NO DESC ) T )WHERE  RNUM BETWEEN ? AND ?";
			
		}else if ("locationCategory".equals(searchType)) {
			//sql(카테고리로검색)
			sql = "SELECT *FROM (  SELECT ROWNUM RNUM, T.* FROM (SELECT P.PLACE_NO, P.PLACE_CATEGORY_NO, P.COUNTRY_NO, P.LOCATION_NO, P.PLACE_NAME AS NAME, P.PLACE_INTRODUCE, P.PLACE_IMAGE, P.PLACE_LAT, P.PLACE_LNG, P.PLACE_TIME, P.PLACE_EXPENSE, PC.PLACE_NAME AS PLACECATEGORY , LC.LOCATION_NAME AS LOCATIONCATEGORY, CC.COUNTRY_NAME AS COUNTRYCATEGORY FROM PLACE P JOIN PLACE_CATEGORY PC ON P.PLACE_CATEGORY_NO = PC.PLACE_CATEGORY_NO JOIN LOCATION_CATEGORY LC ON P.LOCATION_NO = LC.LOCATION_NO JOIN COUNTRY_CATEGORY CC ON P.COUNTRY_NO = CC.COUNTRY_NO WHERE PLACE_NO IS NOT NULL AND LC.LOCATION_NAME LIKE ('%'||?||'%') ORDER BY PLACE_NO DESC ) T )WHERE  RNUM BETWEEN ? AND ?";
			
		}else if ("countryCategory".equals(searchType)) {
			//sql(카테고리로검색)
			sql = "SELECT *FROM (  SELECT ROWNUM RNUM, T.* FROM (SELECT P.PLACE_NO, P.PLACE_CATEGORY_NO, P.COUNTRY_NO, P.LOCATION_NO, P.PLACE_NAME AS NAME, P.PLACE_INTRODUCE, P.PLACE_IMAGE, P.PLACE_LAT, P.PLACE_LNG, P.PLACE_TIME, P.PLACE_EXPENSE, PC.PLACE_NAME AS PLACECATEGORY , LC.LOCATION_NAME AS LOCATIONCATEGORY, CC.COUNTRY_NAME AS COUNTRYCATEGORY FROM PLACE P JOIN PLACE_CATEGORY PC ON P.PLACE_CATEGORY_NO = PC.PLACE_CATEGORY_NO JOIN LOCATION_CATEGORY LC ON P.LOCATION_NO = LC.LOCATION_NO JOIN COUNTRY_CATEGORY CC ON P.COUNTRY_NO = CC.COUNTRY_NO WHERE PLACE_NO IS NOT NULL AND CC.COUNTRY_NAME LIKE ('%'||?||'%') ORDER BY PLACE_NO DESC ) T )WHERE  RNUM BETWEEN ? AND ?";
		}else {
