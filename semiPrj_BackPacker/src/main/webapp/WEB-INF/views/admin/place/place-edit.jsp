...
<script>
	//여행지카테고리
	var placeCategoryNo = "${pv.placeCategoryNo}"; 

    $(document).ready(function() {
        $("#placeSelect").val(placeCategoryNo);
    });
    
	//국가이름
    var countryNo = "${pv.countryNo}"; 
    $(document).ready(function() {
        $("#countrySelect").val(countryNo);
    });
    //지역이름
    var locationNo = "${pv.locationNo}"; 

    $(document).ready(function() {
        $("#locationSelect").val(locationNo);
    });
