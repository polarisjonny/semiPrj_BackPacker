						 ...
						 <div id="info-box">
							...
							<div id="id-area">
								...
								<div id="btn-area">
									...
									<button class="s-btn btn-red" onclick="location.href='${root}/doFpacker/del?no=${gbvo.guideBoardNo}'">삭제</button>
									<script>
...
<script>
		...
		reportBtn.addEventListener('click',function(){
			...
			const left = (screen.width/2)-(width/2);
			const top = 0;
			window.open('${root}/doFpacker/report?boardNo='+no,'', 'width=' + width + ', height=' + height + ', left=' + left + ', top=' + top);
		});
